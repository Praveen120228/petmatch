...
const MatchFeed = () => {
    ...
    const [cityQuery, setCityQuery] = useState(''); // New City filter
    ...
    }, [user, selectedTypes, selectedGender, selectedBreeds, selectedAges, searchQuery, maxDistance, userLoc, locationQuery, countryQuery, stateQuery, cityQuery]);
